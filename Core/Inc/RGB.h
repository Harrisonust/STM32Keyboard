...
#define WS2812_WHITE 	{.R = 255, 	.G = 255, 	.B = 255}
#define WS2812_BLUE 	{.R = 0, 	.G = 0, 	.B = 255}
#define WS2812_RED 		{.R = 255, 	.G = 0, 	.B = 0}
#define WS2812_GREEN 	{.R = 0, 	.G = 255, 	.B = 0}
#define WS2812_PURPLE 	{.R = 255, 	.G = 0, 	.B = 255}
#define WS2812_YELLOW 	{.R = 255, 	.G = 255, 	.B = 0}
#define WS2812_CYAN 	{.R = 0, 	.G = 255, 	.B = 255}
#define WS2812_ORANGE 	{.R = 255, 	.G = 30, 	.B = 0}
#define WS2812_GOLD 	{.R = 255, 	.G = 215, 	.B = 0}
#define WS2812_OLIVE 	{.R = 128, 	.G = 128, 	.B = 0}
#define WS2812_BROWN	{.R = 139, 	.G = 69, 	.B = 19}
#define WS2812_PINK 	{.R = 255, 	.G = 20, 	.B = 147}
